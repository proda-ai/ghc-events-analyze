...
docker run -v $PWD:/outp -t musl-ghc sh -c 'mkdir -p /outp/fonts/share && cp -rvp /root/.cabal/store/ghc-8.4.3/SVGFonts-1.7.0.1-1227c5220f52d1568f166ac8ade7dcf302e864a57f99776fb9f58cad1ed6eef6/share /outp/fonts/ && chmod -R o+rwx /outp/fonts'
